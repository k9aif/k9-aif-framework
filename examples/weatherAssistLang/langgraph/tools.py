...
def get_weather_for_city(city: str) -> str:
    ...
    Returns a plain-English factual weather payload for downstream use.

    Identical logic to weather_assist/crewai/tools.py's get_weather_for_city,
    minus the CrewAI @tool decorator -- this graph calls it as a plain
    Python function from a node rather than as an LLM-invoked tool, since
    the fetch step here is deterministic (see graph.py's fetch_weather_node
    docstring for why).
    """
