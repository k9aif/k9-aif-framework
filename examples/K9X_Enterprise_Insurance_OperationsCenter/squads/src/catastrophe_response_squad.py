...
# K9-AIF EOC — CatastropheResponseSquad (SBB)
...
class CatastropheResponseSquad(BaseSquad):
    """
    SBB Squad for CatastropheResponseSquad.
    ...
    def run(self, request: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Delegate to CatastropheResponseOrchestrator."""
        context = context or {}
